...
- [LLM-JP 4 VL](https://huggingface.co/llm-jp/llm-jp-4-vl-9b-beta)
...
- [SAM 3D（SAM License, 要継承）](https://ai.meta.com/sam3d/)  [<model>](https://github.com/facebookresearch/sam-3d-objects), Body版もあり
...
- [Pixal 3D](https://github.com/TencentARC/Pixal3D): Image-to-3D

### World Model 🌍
- [Cosmos 3](https://research.nvidia.com/labs/cosmos-lab/cosmos3/)
- [HY-World 2](https://github.com/Tencent-Hunyuan/HY-World-2.0)
